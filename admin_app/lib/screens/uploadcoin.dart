...
import 'package:admin_app/widgets/progress_bar.dart';
...
class _UploadBrandsScreenState extends State<UploadBrandsScreen> {
  ...
  saveBrandInfo() {
    FirebaseFirestore.instance
        .collection("Admin")
        .doc(sharedPreferences?.getString("user.uid"))
        .collection("brands")
        .doc(brandUniqueId)
        .set({
      "brandID": brandUniqueId,
      "sellerUID": sharedPreferences?.getString("user.uid"),
    ...
    Navigator.push(context, MaterialPageRoute(builder: (c) => Items()));
  }
